...
If you'd like to develop and/or build the Jupyter Book book, you should:
...
We welcome and recognize all contributions. You can see a list of current contributors in the [contributors tab](https://github.com/nickburrows/notebooks/graphs/contributors).
